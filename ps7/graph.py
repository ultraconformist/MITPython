...
class WeightedEdge(Edge):
    def __init__(self, src, dest, total_distance, outdoor_distance):
        """Represents a weighted edge in the dictionary. Includes a source,
        destination, total distance, and outdoor distance."""
        self.src = src
        self.dest = dest
    ...
    def __str__(self):
        src_name = self.src.get_name()
        dest_name = self.dest.get_name()
        return '{}->{} ({}, {})'.format(src_name, dest_name,\
